...
| --- | --- | --- |
| process_lines | process lines | 14 |
| blue_A | BLUE → A / A′ | 7 |
| cyan_B_2K | CYAN → B / B′ | 0 |
| green_W_coupler | GREEN → W | 0 |
| grey_V_vent | GREY → V | 0 |
| olive_S_line | OLIVE → S | 4 |
| red_orange_D_E | RED / ORANGE → D/E | 0 |
| unknown_black_or_other | BLACK/unknown → structure/unknown | 3 |
| instruments | instruments | 0 |
| valves | valves | 4 |
| equipment | equipment | 4 |
| boundaries | boundaries | 8 |
| arrows | arrows | 1 |
| unresolved_objects | unresolved objects | 12 |
| subsystem_qm | QM | 32 |
| subsystem_jumper | Jumper | 2 |
| subsystem_qvb | QVB | 0 |
| subsystem_qinfra | QINFRA | 23 |
