...
## Replay Commands (Deterministic)
1. `python engines/parser.py`
2. `python engines/normalize.py`
3. `python engines/governance_parser.py --target .github/W003_PR_FOLLOW_UP.md --schema schema/governance_header.schema.json`
4. `python engines/validator.py`
5. `python engines/html_renderer.py`
6. `python engines/build_manifest.py`
