...
Use these governance constraints for runtime and renderer changes:
...
4. Use stateless event-driven navigation patterns aligned with `src/runtime/interactive/wave13_interactive_runtime_layer.py`.
