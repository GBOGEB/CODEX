...
Table 1 Main interfacing and helium transport lines [14](#_Ref211431913)

Table 2 Operational Scenarios [19](#_Ref192158138)

Table 3 Heat Loads Summary from QCELLs and Cryogenic Distribution
[22](#_Toc200491806)

Table 4 Fluid Conditions at the Refrigerator Cold Box Interfaces for
Different Operating Scenarios [23](#_Ref192161189)

Table 5 Temperature measurement precision [27](#_Ref185259881)

Table 6 He Leakage requirements (excluding via permeation and
diffusivity) [30](#_Ref184046879)

Table 7 Helium Inventory [31](#_Ref185003225)

Table 8 Measuring Points for WCS [35](#_Ref192500058)

Table 9 Measuring Points for QRB [39](#_Ref184110805)

Table 10 Measuring points for gas helium storages. [41](#_Ref184111599)

Table 11 Interface ID between QRB and QDIST (cold interfaces)
[52](#_Ref210725562)

Table 12 Preliminary pipe diameters for the QLM [53](#_Ref192519000)

Table 13 Interface ID between QRB and QINFRA (warm interfaces)
[53](#_Toc212194970)

Table 14 Internal QPLANT Distribution Lines (crossing multiple rooms)
[54](#_Toc212194971)

Table 15 Warm lines at room temperature [54](#_Toc201310423)

Table 16 External Helium User Quantification [59](#_Toc212194973)

Table 17 Project Lifecycle Phases. [70](#_Toc212194974)

Table 18 Documentation and Deliverables [71](#_Ref192660562)

Table 19 Pressure Equipment and Safety Standards [77](#_Toc201310425)

Table 20 Functional Safety & Control Standards [77](#_Toc201310426)

Table 21 Asset & Maintenance Management [78](#_Toc201310427)

Table 22 Cleanliness And Purity [78](#_Toc201310428)

Table 23 Preliminary Schedule and Main Milestones [80](#_Ref192752742)

Table 24 System mass [92](#_Toc212194981)

Table 25 Weighted Average Enthalpy Data (1K - 300K) [93](#_Toc212194982)

Table 26 Instructions for GSHRC [94](#_Ref192251100)

Table 27 Control Architecture details [95](#_Ref211488897)

Table 28 Applicable Documents (AD) [98](#_Toc201310432)
