...
<!-- G10_SUMMARY_START (auto-generated — do not edit manually) -->
## G10 Production Closure

The Generation 10 runtime artifacts are published under `docs/deck-systems/abacus-render-pipeline/`.

- [File Matrix](docs/deck-systems/abacus-render-pipeline/files.html)
- [Runtime Overview](docs/deck-systems/abacus-render-pipeline/runtime_overview.html)
- [Slide Presentation](docs/deck-systems/abacus-render-pipeline/slides_html.html)
- [Runtime Summary](docs/deck-systems/abacus-render-pipeline/runtime_summary.md)
<!-- G10_SUMMARY_END -->
